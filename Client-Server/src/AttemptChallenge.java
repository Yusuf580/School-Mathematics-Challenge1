...
PreparedStatement statement=conn.prepareStatement(sql);
 ...
 statement.setString(2,user1);
    ...
    //Method calculates the most correctly answered questions
    private void correctlyAnswered(String ansId) throws ClassNotFoundException, SQLException {
        String sql="UPDATE answers SET count=? WHERE answer_id=?";
        String sql1="SELECT count FROM answers WHERE answer_id=?";
        Class.forName("com.mysql.cj.jdbc.Driver");
        Connection conn = DriverManager.getConnection(DB_URL, USER, PASS);
        ...
        while(resultSet.next()){
            ...
            statement1.setInt(1,Count+1);
            statement1.setString(2,ansId);
        }
